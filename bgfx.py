...
vertex_decl_begin = _bind("bgfx_vertex_decl_begin", [POINTER(vertex_decl), c_uint32])
vertex_decl_add = _bind("bgfx_vertex_decl_add", [POINTER(vertex_decl), c_uint32, c_uint8, c_uint32, c_bool])
vertex_decl_skip = _bind("bgfx_vertex_decl_skip", [POINTER(vertex_decl), c_uint8])
...
dbg_text_image = _bind("bgfx_dbg_text_image", [c_uint16, c_uint16, c_uint16, c_uint16, c_void_p, c_uint16])
create_index_buffer = _bind("bgfx_create_index_buffer", [POINTER(bgfx_memory), c_uint16], bgfx_index_buffer_handle)
destroy_index_buffer = _bind("bgfx_destroy_index_buffer", [bgfx_index_buffer_handle])
create_vertex_buffer = _bind("bgfx_create_vertex_buffer", [POINTER(bgfx_memory), POINTER(vertex_decl), c_uint16], bgfx_vertex_buffer_handle)
destroy_vertex_buffer = _bind("bgfx_destroy_vertex_buffer", [])
create_shader = _bind("bgfx_create_shader", [POINTER(bgfx_memory)], bgfx_shader_handle)
create_program = _bind("bgfx_create_program", [bgfx_shader_handle, bgfx_shader_handle, c_bool], bgfx_program_handle)
destroy_program = _bind("bgfx_destroy_program", [bgfx_program_handle])
set_state = _bind("bgfx_set_state", [c_uint64, c_uint32])
set_index_buffer = _bind("bgfx_set_index_buffer", [bgfx_index_buffer_handle, c_uint32, c_uint32])
set_vertex_buffer = _bind("bgfx_set_vertex_buffer", [bgfx_vertex_buffer_handle, c_uint32, c_uint32])
